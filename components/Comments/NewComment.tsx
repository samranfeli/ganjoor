    ...
    return (
        <div>
            ...
            <div className="p-4 border text-justify bg-white rounded my-2 md:my-4">
                ...
                <p className="mb-2 md:mb-4">
                    <span className="text-green-500">لطفاً در صورتی که تفاوتها را با استناد به نسخه&zwnj;های چاپی یا خطی گزارش می&zwnj;کنید این مسئله را با ذکر منبع مطرح نمایید. اشتباهات تایپی و غلطهای املایی را <a href="/User/Editor?id=2137">ویرایش</a> و تصحیح کنید.</span>
                </p>
            </div>
        </div>
    )
